      ...
      <div className="lg:w-4/5 w-11/12 mx-auto flex lg:flex-row flex-col-reverse justify-between gap-8">
        ...
        <div className="divider md:w-2/5 w-3/5 pb-5"></div>
          ...
          <div className="form-control mt-6">
            <button className="btn bg-purple-600 text-white text-lg font-bold md:w-2/6 w-full border-none">
              Send Message
            </button>
          </div>
        </form>
        ...
        <h4 className="md:text-xl text-gray-700 flex gap-x-3 items-center"><ImLocation className="text-xl text-accent" /> <span className="font-semibold">Khulna, Bangladesh</span></h4>

        <h4 className="md:text-xl text-gray-700 flex gap-x-3 items-center"><MdEmail className="text-xl text-indigo-500" /> <span className="font-semibold">tondramou3@gmail.com</span></h4>

        <h4 className="md:text-xl text-gray-700 flex gap-x-3 items-center"><FaPhoneAlt className="text-xl text-success" /> <span className="font-semibold">+8801633910434</span></h4>

        <h4 className="md:text-xl text-gray-700 flex gap-x-3 items-center"><ImWhatsapp className="text-2xl text-lime-500" /> <span className="font-semibold">+8801633910434</span></h4>
        </div>
      </div>
    </div>
  );
