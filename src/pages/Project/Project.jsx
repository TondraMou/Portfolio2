...
const Project = () => {
  ...
  return (
    <div className="py-20 lg:w-4/5 w-11/12 mx-auto">
      ...
      <div className="flex flex-col border border-gray-200 bg-slate-100 gap-4 shadow-md rounded-box">
        <img
          src={project.image}
          alt={project.name}
        ...
        <div className="lg:pr-14 pr-8 pl-5 pb-8 space-y-3">
          ...
          <div className="flex gap-4 items-center pt-4">
            <Link
              ...
              className="flex gap-2 items-center btn bg-purple-100 text-black md:text-lg font-bold md:px-8 px-4 rounded-full"
            >
            ...
            <Link
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex gap-2 items-center btn bg-purple-600 text-white md:text-lg font-bold md:px-8 px-4 rounded-full"
            >
      ...
      <div className="mt-10">
        <Link
          to="/projects"
          className="btn btn-outline border-2 border-purple-600 text-purple-600 hover:border-none font-bold hover:bg-purple-600 text-lg hover:text-white px-6"
        >
          Back to Projects
        </Link>
      </div>
