    ...
    <div className="lg:w-4/5 w-11/12 mx-auto pt-20 pb-16">
      ...
      <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-8">
        {projects.map((project) => (
          <div
            key={project.id}
            className="card bg-slate-100 rounded-lg shadow-md hover:shadow-2xl hover:scale-105 transition-transform duration-300"
          >
            <img
            ...
            <div className="p-4 space-y-2">
              ...
              <Link to={`/project/${project.id}`}>
                <button className="mt-5 btn bg-purple-600 rounded-none border-none text-white font-bold px-8 hover:btn-neutral flex gap-2 items-center">
